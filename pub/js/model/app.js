...
//    var callbacks = {};
    ...
    var dict = {
        'RU': {
            ...
            basic_header: 'Весь базовый функционал Testix. Бесплатно',
            basic_desc: 'Хотите привлечь пользователей по-настоящему интересным контентом?<br>Не тратьте время на поиски сложных решений – теперь вы можете создать уникальный<br>интерактивный контент за минуты. А главное, совершенно бесплатно.',
            create_project: 'Создать проект',
            basic_feature_h1: 'Весь базовый функционал Testix',
            ...
            basic_feature_h3: 'До 5 000 просмотров в месяц',
            basic_feature_a3: 'Считается сумма неуникальных просмотров проектов в месяц',
            basic_feature_h4: 'Логотип Testix',
            basic_feature_a4: 'Проекты публикуются с логотипом Testix. При этом вы можете добавить в проект ваш логотип',
            basic_feature_h5: 'Возможна реклама',
            basic_feature_a5: 'Реклама может быть включена автоматически',
            basic_feature_h6: 'Код для вставки на сайт',
            basic_feature_a6: 'Простая интеграция проекта в ваш сайт или блог.',
            ...
            basic_feature_h8: 'Google аналитика',
            basic_feature_a8: 'Доступно подключение счетчика Google Analytics',
            answers_questions: 'Вопросы и ответы',
            basic_faq_q1: 'Что будет при превышении лимита просмотров?',
            basic_faq_a1: 'При превышении лимита просмотров может быть включен показ рекламы. При этом проект не исчезает и не блокируется.',
            basic_faq_q2: 'Можно ли использовать бесплатный тариф для коммерческих проектов?',
            basic_faq_a2: 'Да, вы можете использовать бесплатный тариф для создания коммерческих проектов или рекламы. Тем не менее, для этих целей лучше всего подходят наши платные тарифы.',
        ...
        'EN': {
            ...
            // free tariff page
            basic_header: 'All common Testix platform features. For free.',
            basic_desc: 'Want to attract users with really interesting content?<br>Do not waste time searching for complex solutions - now you can create unique and interactive content in minutes. And completely free.',
            create_project: 'Create project',
            basic_feature_h1: 'Testix platform features',
            ...
            basic_feature_h3: 'Up to 5 000 views per month',
            basic_feature_a3: 'The amount of non-unique project views per month',
            basic_feature_h4: 'Testix logo',
            basic_feature_a4: 'Projects are published with the Testix logo. Also you can add your logo to the project',
            basic_feature_h5: 'Advertising',
            basic_feature_a5: 'Advertising can be shown automatically',
            basic_feature_h6: 'Embed code for your site',
            basic_feature_a6: 'Simple project integration into your website or blog',
            basic_feature_h7: 'Project direct link',
            basic_feature_a7: 'If you do not have the opportunity to embed html-code on the site, you can use a direct link to your project',
            basic_feature_h8: 'Google Analytics',
            basic_feature_a8: 'You can connect to the Google Analytics counter',
            answers_questions: 'Frequently Asked Questions',
            basic_faq_q1: 'What happens when the view limit is exceeded?',
            basic_faq_a1: 'When the view limit is exceeded, advertising may be enabled. The project is not blocked.',
            basic_faq_q2: 'Can I use a free tariff for commercial projects?',
            basic_faq_a2: 'Yes, you can use a free tariff to create commercial projects or advertisements. Nevertheless, for these purposes, our paid tariffs are best suited.',
            basic_faq_q3: 'Are there limits on the number of published tests per month?',
            basic_faq_a3: 'No, you can create an unlimited number of tests or other projects.',
