...
PersonalityResultLinking.prototype.onOptionClick = function(event) {
    var optionId = $(event.currentTarget).attr('data-option-id');
    this.selectOption(optionId);
};

PersonalityResultLinking.prototype.onResultMouseover = function(event) {
    var $e = $(event.currentTarget);
    $e.find('.js-result_hover').show();
};

PersonalityResultLinking.prototype.onResultMouseout = function(event) {
    var $e = $(event.currentTarget);
 ...
 * @param event
 */
PersonalityResultLinking.prototype.onResultLinkWeak = function(event) {
 ...
 * @param event
 */
PersonalityResultLinking.prototype.onResultLinkStrong = function(event) {
    var resultId = $(event.currentTarget).parent().parent().parent().parent().attr('data-result-id');
    console.log('resultId: '+resultId);
    // если задается связь одного типа то надо удалить связь другого типа
    // если связка уже есть не добавлять повторно
 ...
 */
PersonalityResultLinking.prototype.deleteResultLinksForOption = function(optionId, resultId) {
 ...
 * return {Array}
 */
PersonalityResultLinking.prototype.valueToArray = function() {
    var result = [];
 ...
 * @returns {*}
 */
PersonalityResultLinking.prototype.getOptionValue = function(optionId) {
    for (var key in this._value) {
 ...
 */
PersonalityResultLinking.prototype.selectOption = function(optionId) {
